...
#parser.add_argument('--pretrained', default="/home/user/cjl/Aug_simsiam_clu/aug_loss3_1_4_gailr_coco_b_128_e_100_lr_0.05/checkpoint_20.pth.tar", type=str,
#parser.add_argument('--pretrained', default="/home/user/cjl/Aug_simsiam_clu/aug_loss3_1_4_coco_b_128_e_100_lr_0.05/checkpoint_10.pth.tar", type=str,
#parser.add_argument('--pretrained', default="/home/user/cjl/Aug_simsiam_clu/aug_loss3_1_4_qu_p_coco_b_128_e_100_lr_0.05/checkpoint_10.pth.tar", type=str,
#parser.add_argument('--pretrained', default="/home/user/cjl/Aug_simsiam_clu/ori_IM_512_100epcheckpoint_0099.pth.tar", type=str,
parser.add_argument('--pretrained', default="/home/user/cjl/Aug_simsiam_clu/aug_loss3_e400_cross03_coco_b_124_lr_0.05/checkpoint_40.pth.tar", type=str,
                    help='path to simsiam pretrained checkpoint')
parser.add_argument('--lars', default=False,action='store_true',
                    help='Use LARS')
parser.add_argument('--save-dir', default='./448_loss3_cross03_e400_coco_lincs_b_64_lr_10_1_4_withcsra', type=str, metavar='PATH',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = Backbone(80, Bottleneck, [3, 4, 6, 3] )
